...
if(isset($_POST['btn_save'])) {
  ...
  mysqli_query($conn,"insert into products (product_category, product_title, product_description, product_image, product_keywords, product_brand) values ('$product_type','$product_name','$details','$pic_name','$tags','$brand')") or die ("query incorrect");
