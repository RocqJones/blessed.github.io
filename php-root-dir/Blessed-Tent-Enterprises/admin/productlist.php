 <?php
                  ...
                  <div class="table-responsive ps">
                    ...
                    <tbody>
                        <?php 
                          ...
                          $result=mysqli_query($conn,"select product_id, product_image, product_title from products where  product_category=2 or product_category=3 or product_category=4 or product_category=5 Limit $page1, 12") or die ("query 1 incorrect.....");

                          while(list($product_id,$product_image,$product_title)=mysqli_fetch_array($result)) {
                            echo "<tr><td><img src='../product_images/$image' style='width:50px; height:50px; border:groove #000'></td><td>$product_title</td>
                            <td>
  ...
  //counting paging
                  ...
                  $paging=mysqli_query($conn,"select product_id, product_image, product_title from products");
